...
<!-- Start Banner Hero -->
<section id="start" class="aboutStart caseHero" data-aos="fade-right" data-aos-duration="2000">
    <div class="container">
...
<!-- Start Team Member -->
<section class="members" id="sectionMembers">
    <div class="container">
        ...
        <div class="row text-center">
            <div class="owl-carousel owl-theme">
                <?php foreach ($logos as $logo) : ?>
                    <div class="item">
                        <h4><img src="<?= get_field("logo", $logo->ID) ?>" class="img-responsive" alt="logo1"> </h4>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
...
<section class="creative">
    <div class="container">
        <div class="row creative--wrapper">
            <div class="col-12 col-md-6 creative--wrapper__heading" data-aos="fade-right" data-aos-duration="1500">
            ...
            <div class="col-12 col-md-6 creative--wrapper__content">
    ...
    <div class="container my-4">
        <div class="row">
            <div class="why-us--img col-lg-5">
                <img src="http://localhost/wordpress/wp-content/uploads/2022/01/work.png" class="rounded img-fluid" alt="">
            </div>
